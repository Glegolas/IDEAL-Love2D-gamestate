...
###### NOTE: This documentation assumes the user has some knowledge of basic programming concepts, LOVE2D, and LUA. The mentions of 'tags' and 'sub-tags' are not actual syntax of the programming language, but rather are used as landmarks for readibility
